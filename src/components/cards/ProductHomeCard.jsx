  ...
  return (
    <div className="w-80 bg-white shadow rounded">
      ...
      <div className="p-4 flex flex-col items-center">
        ...
        <NavLink to={``} className="py-2 px-4 bg-blue-500 text-white rounded hover:bg-blue-600 active:bg-blue-700 disabled:opacity-50 mt-4 w-full flex items-center justify-center">
          Add to card
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6 ml-2"
