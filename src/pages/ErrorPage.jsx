...
export default function ErrorPage() {
  return (
    ...
    // style="background-image: url('https://source.unsplash.com/random/1920x1080?nature')" style={{backgroundImage:`url('https://source.unsplash.com/random/1920x1080?nature')`}}    >
